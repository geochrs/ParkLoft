      ...
      <div className={classes.container} data-aos="fade">
        ...
        <div className={classes.cards}>
          <div className={classes.card}>
            <img src={how1} alt="Look for parking" className={classes.img} />
          ...
          <div className={classes.card}>
            <img src={how2} alt="Book parking" className={classes.img} />
            <h3 className={classes.h3}>Book</h3>
            <p>Select date and time, check availability, see prices.</p>
          </div>
          <div className={classes.card}>
            <img src={how3} alt="Park parking" className={classes.img} />
